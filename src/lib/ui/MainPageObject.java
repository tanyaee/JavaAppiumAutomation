...
public class MainPageObject {
    ...
    public WebElement waitForElementAndClick(String locator, String errr_message, long timeoutInSeconds) {

        WebElement element = waitForElementPresent(locator, errr_message, timeoutInSeconds);
        element.click();
        return element;
    ...
    public WebElement waitForElementAndSendKeys(String locator,  String value, String errr_message, long timeoutInSeconds) {
        WebElement element = waitForElementPresent(locator, errr_message, timeoutInSeconds);
    ...
    public void assertElementContainsText(WebElement element, String expected_text, String error_message) {
    ...
    {
        int element_location_by_y = this.waitForElementPresent(locator,"Cannot find element by locator " + locator,3).getLocation().getY();
    ...
    public List<WebElement> getSearchResultElements(String locator)
    {
        By by = this.getLocatorByString(locator);
        ...
        List<WebElement> search_result = driver.findElements(by);
    ...
    {
        WebElement element = this.waitForElementPresent(locator, error_message,3);
