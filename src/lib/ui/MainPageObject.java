...
public class MainPageObject {
    ...
    public WebElement waitForElementAndClick(By by, String errr_message, long timeoutInSeconds) {
    ...
    public WebElement waitForElementAndSendKeys(By by,  String value, String errr_message, long timeoutInSeconds) {
        WebElement element = waitForElementPresent(by, errr_message, timeoutInSeconds);
